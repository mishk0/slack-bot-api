...
- `getChannel(name)` (return: promise) - gets group by name,
- `getGroup(name)` (return: promise) - gets channel by name,
- `getUser(name)` (return: promise) - gets user by name,
- `getChannelId(name)` (return: promise) - gets group ID by name,
- `getGroupId(name)` (return: promise) - gets channel ID by name,
